...
#define RADIO_UP_Pin GPIO_PIN_13
#define RADIO_UP_GPIO_Port GPIOC
#define RADIO_UP_EXTI_IRQn EXTI15_10_IRQn
...
#define MCU_ACTIVE_Pin GPIO_PIN_2
#define MCU_ACTIVE_GPIO_Port GPIOC
#define RADIO_DOWN_Pin GPIO_PIN_0
#define RADIO_DOWN_GPIO_Port GPIOA
#define RADIO_DOWN_EXTI_IRQn EXTI0_IRQn
